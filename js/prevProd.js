//Saves location index to variable, then to local storage to be retrieved in viewLocations page. Passes user to this page.
function viewLocation(locationIndex)
{ 
    locationIndexToPass = locationIndex;
    
    localStorage.setItem("locationIndexToPass", locationIndexToPass);
